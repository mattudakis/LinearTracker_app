...
namespace eval ttk::theme::azure-dark {
	...
	ttk::style layout Switch_vert.TCheckbutton {
            Switch_vert.button -children {
                Switch_vert.padding -children {
                    Switch_vert.indicator -side left
                    Switch_vert.label -side right -expand true
                }
            }
        }
        ...
        # Button
        ttk::style configure TButton -padding {8 4 8 4} -width -10 -anchor center -justify center
	...
	# Switch_vert
        ttk::style element create Switch_vert.indicator image \
            [list $I(off-basic_v) \
                {selected disabled} $I(on-basic_v) \
                disabled $I(off-basic_v) \
                {pressed selected} $I(on-accent_v) \
                {active selected} $I(on-accent_v) \
                selected $I(on-accent_v) \
                {pressed !selected} $I(off-accent_v) \
                active $I(off-accent_v) \
            ] -width 26 -sticky w
        ...
        ttk::style element create Combobox.field \
            image [list $I(box-basic) \
                ...
                {readonly pressed} $I(box-basic) \
                {readonly focus hover} $I(box-hover) \
                {readonly focus} $I(box-basic) \
                {readonly hover} $I(box-hover) \
                {focus hover} $I(box-hover) \
        ...
        ttk::style element create Combobox.button \
            image [list $I(combo-button-basic) \
                 {!readonly focus} $I(combo-button-basic) \
                 {readonly focus} $I(combo-button-basic) \
